...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-brand text-base font-medium leading-5 text-gray-900 focus:outline-none focus:border-brand transition duration-150 ease-in-out'
