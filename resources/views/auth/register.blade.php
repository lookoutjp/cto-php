<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="nameread" class="block mt-1 w-full" type="text" name="nameread" :value="old('nameread')" autocomplete="off" />
            <x-input-error :messages="$errors->get('nameread')" class="mt-2" />
        </div>
